...
# 설명서
echo -e "\e[96m╔═════════════════════════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96m║\e[1m 서버 백업데이터 복구 작업 전 설명드립니다. \e[0m                         \e[96m║\e[0m"
